...
int32_t* source_height = (int32_t*)0x8070000 + 
                          (50*sizeof(int32_t)) + 
                          (NUM_NODES*sizeof(int32_t)*3) +
                          (NUM_NODES*(NUM_NEIGHBOURS+1)*sizeof(int32_t)*3);
                         
int32_t* source_excess_flow = (int32_t*)0x8080000 + 
                               (50*sizeof(int32_t)) + 
                               (NUM_NODES*sizeof(int32_t)*3) +
                               (NUM_NODES*(NUM_NEIGHBOURS+1)*sizeof(int32_t)*2) +
...
int32_t* source_curr_capacities = (int32_t*)0x80900000 + 
                                  (50*sizeof(int32_t)) + 
                                  (NUM_NODES*sizeof(int32_t)*3) +
                                  (NUM_NODES*(NUM_NEIGHBOURS+1)*sizeof(int32_t)*2) +
...
int32_t* source_capacities = (int32_t*)0x80A0000 + 
                            (50*sizeof(int32_t)) + 
